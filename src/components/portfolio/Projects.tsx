...
export function Projects() {
  ...
  return (
    <section id="projects" className="mb-28 scroll-mt-24 sm:mb-32">
      <div className="mb-12 flex items-end justify-between border-b border-border pb-5 gap-6">
        <div>
          <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.2em] text-accent">03 / WHAT I'VE BUILT</p>
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-5xl">
            Selected Work <span className="font-mono text-base font-bold text-muted-foreground">[{String(projects.length).padStart(2, "0")}]</span>
          </h2>
        </div>
