    ...
    <Reveal as="section" className="mb-28 scroll-mt-24 sm:mb-32">
      <div id="about" className="scroll-mt-24">
        <div className="mb-10 border-b border-border pb-5">
          <p className="mb-2 font-mono text-[10px] uppercase tracking-[0.2em] text-accent">01 / WHO I AM</p>
          <h2 className="text-4xl font-extrabold tracking-tight sm:text-6xl">Behind the Code</h2>
        </div>
